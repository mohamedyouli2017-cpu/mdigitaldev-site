...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Mohamed on WhatsApp"
    ...
    >
      ...
      />
      {/* Inner pulse ring — slightly faster */}
      <span
      ...
      <motion.div
        ...
        whileTap={{ scale: 0.93 }}
        className="relative w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-[0_4px_24px_rgba(37,211,102,0.55)] group-hover:shadow-[0_8px_36px_rgba(37,211,102,0.75)] transition-shadow duration-300"
      >
        <WhatsAppIcon />
      </motion.div>
    </a>
