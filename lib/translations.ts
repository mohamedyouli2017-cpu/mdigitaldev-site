  ...
  en: {
    ...
    about: {
      ...
      stats: [
        ...
        { label: "Enterprise Tech Stack", desc: "Next.js, AI APIs, Make, Zapier & beyond" },
        { label: "Creative Studio",       desc: "Conversion-focused design & AI automation" },
      ],
    },
    powerTrio: {
  ...
  fr: {
    ...
    about: {
      ...
      stats: [
        ...
        { label: "Stack Entreprise", desc: "Next.js, APIs IA, Make, Zapier & plus encore" },
        { label: "Studio Créatif",  desc: "Design orienté conversion & automatisation IA" },
      ],
    },
    powerTrio: {
  ...
  ar: {
    ...
    about: {
      ...
      stats: [
        ...
        { label: "تقنيات المؤسسات", desc: "Next.js وواجهات الذكاء الاصطناعي و Make و Zapier" },
        { label: "استوديو إبداعي",   desc: "تصميم موجّه للتحويل وأتمتة بالذكاء الاصطناعي" },
      ],
    },
    powerTrio: {
