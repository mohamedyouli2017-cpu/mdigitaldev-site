...
export const translations: Record<Lang, LangTranslations> = {
  ...
  en: {
    ...
    hero: {
      ...
      h1a:    "Websites + AI",
      h1b:    "Agents That Work",
      h1c:    "While You Sleep.",
      sub:    "I build high-performance websites powered by AI automation — so your business handles bookings, follow-ups, and operations automatically.",
      cta1:   "Start Your Project",
      cta2:   "View Live Demos",
      scroll: "Scroll",
      stats:  { projects: "PageSpeed Score", pagespeed: "App Ready", revenue: "Load Time", response: "Powered Agents" },
    },
    about: {
