...
export const translations: Record<Lang, LangTranslations> = {
  ...
  en: {
    ...
    process: {
      label: "HOW WE WORK", headline: "A Proven Process, Every Time.",
      sub: "From first conversation to deployment — here's how every project moves forward.",
      timeNote: "We prioritize quality and speed, ensuring each solution is rigorously tested and optimized before delivery.",
      items: [
        {
          number: "01", title: "Discovery & Strategy",
          desc: "We analyze your business bottlenecks to identify where AI and Automation can save you time and increase revenue.",
        },
        {
          number: "02", title: "Blueprint & Solution Design",
          desc: "We design a custom architecture for your AI agents and automated workflows, ensuring they align perfectly with your brand.",
        },
        {
          number: "03", title: "Intelligent Build & Integrate",
          desc: "Our experts build your AI-ready ecosystem, integrating advanced models and connecting all your business tools seamlessly.",
        },
        {
          number: "04", title: "Launch & Scaling Support",
          desc: "We deploy your system for maximum performance and provide 30-day support to ensure smooth operations and growth.",
        },
      ],
    },
    contact: {
  ...
  fr: {
    ...
    process: {
      label: "NOTRE MÉTHODE", headline: "Un Processus Éprouvé, à Chaque Fois.",
      sub: "De la première conversation au déploiement — voici comment chaque projet avance.",
      timeNote: "Nous privilégions la qualité et la rapidité, en veillant à ce que chaque solution soit rigoureusement testée et optimisée avant la livraison.",
      items: [
        {
          number: "01", title: "Découverte & Stratégie",
          desc: "Nous analysons les points de friction de votre entreprise pour identifier où l'IA et l'Automatisation peuvent vous faire gagner du temps et augmenter vos revenus.",
        },
        {
          number: "02", title: "Plan & Conception de Solution",
          desc: "Nous concevons une architecture sur mesure pour vos agents IA et workflows automatisés, pour qu'ils s'alignent parfaitement avec votre marque.",
        },
        {
          number: "03", title: "Construction Intelligente & Intégration",
          desc: "Nos experts construisent votre écosystème IA, en intégrant des modèles avancés et en connectant tous vos outils métier en toute transparence.",
        },
        {
          number: "04", title: "Lancement & Support de Croissance",
          desc: "Nous déployons votre système pour une performance maximale et fournissons 30 jours de support pour assurer des opérations fluides et votre croissance.",
        },
      ],
    },
    contact: {
  ...
  ar: {
    ...
    process: {
      label: "طريقة عملنا", headline: "عملية مثبتة، في كل مرة.",
      sub: "من أول محادثة حتى الإطلاق — هكذا يتقدّم كل مشروع.",
      timeNote: "نحن نولي الأولوية للجودة والسرعة، مع ضمان اختبار كل حل وتحسينه بدقة قبل التسليم النهائي.",
      items: [
        {
          number: "01", title: "الاستكشاف والاستراتيجية",
          desc: "نحلل تحديات عملك لتحديد المجالات التي يمكن للذكاء الاصطناعي والأتمتة فيها توفير الوقت وزيادة الأرباح.",
        },
        {
          number: "02", title: "التخطيط وتصميم الحل",
          desc: "نصمم بنية مخصصة لوكلاء الذكاء الاصطناعي ومسارات العمل الآلية، لضمان توافقها التام مع علامتك التجارية.",
        },
        {
          number: "03", title: "البناء الذكي والدمج",
          desc: "يبني خبراؤنا نظامك الذكي، مع دمج النماذج المتقدمة وربط جميع أدوات عملك بسلاسة.",
        },
        {
          number: "04", title: "الإطلاق ودعم النمو",
          desc: "نطلق نظامك بأقصى أداء، ونوفر دعماً لمدة 30 يوماً لضمان سير العمليات ونمو مشروعك بسلاسة.",
        },
      ],
    },
    contact: {
