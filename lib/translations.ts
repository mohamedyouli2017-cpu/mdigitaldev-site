      ...
      items: [
        {
          ...
          features: ["صفحة هبوط متجاوبة", "قائمة طعام بالصور", "تكامل خرائط Google", "زر واتساب للتواصل", "إعداد SEO أساسي", "⚡ تسليم في 24 ساعة"],
          cta: "ابدأ الآن", waMsg: "مرحباً محمد، أريد البدء بالباقة الأساسية لمطعمي.",
        },
        {
          tier: "الباقة الاحترافية", name: "نظام مطعم متكامل",
          desc: "حضور إلكتروني كامل مع الطلبات وتنبيهات واتساب والحجوزات ولوحة تحكم للإدارة. كل ما يحتاجه مطعم عصري.",
          features: ["كل ما في الأساسية", "نظام طلب إلكتروني", "تنبيهات واتساب للطلبات", "نظام حجز الطاولات", "لوحة تحكم للإدارة", "تطبيق PWA قابل للتثبيت", "تسليم في 3 أيام"],
          cta: "الأكثر طلباً", waMsg: "مرحباً محمد، أنا مهتم بالباقة الاحترافية لتطوير أعمالي.",
        },
        {
          tier: "الباقة المتميزة", name: "منصة SaaS / سحابية",
          desc: "حلول سحابية مخصصة: إدارة متعددة الفروع، برامج الولاء، لوحات التحليلات ومنصات SaaS قابلة للتطوير للعلامات الطموحة.",
          features: ["كل ما في الاحترافية", "إدارة متعددة الفروع", "نظام ولاء ومكافآت", "لوحة تحليلات متقدمة", "تكاملات مخصصة", "دعم مخصص ومتواصل", "تسليم في أسبوع واحد"],
